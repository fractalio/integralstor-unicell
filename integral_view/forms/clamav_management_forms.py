...
class ScanDirectory(forms.Form):
    scan_directory = forms.CharField(label='Scan Directory', max_length=100)

class Config(forms.Form):
    dct,err = clamav.get_file()
    ...
    dct_updater,err = clamav.get_file_updater()
